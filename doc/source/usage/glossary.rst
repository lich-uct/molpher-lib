...
..  glossary::
    ...
    exploration parameters
        A set of parameters (represented by the `molpher.core.ExplorationData` class) that define
        how the new morphs are generated, the tree is pruned, what similarity measure is used, etc. See
        the description of `molpher.core.ExplorationData` for details.
    ...
    XML template
        ...
        (using the :py:meth:`ExplorationTree.ExplorationTree.create()` method).
