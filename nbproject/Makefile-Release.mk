...
${TESTDIR}/tests/minimal_test/MinimalTest.o: tests/minimal_test/MinimalTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/minimal_test/MinimalTest.o tests/minimal_test/MinimalTest.cpp


${TESTDIR}/tests/minimal_test/MinimalTestRunner.o: tests/minimal_test/MinimalTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests/minimal_test
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/minimal_test/MinimalTestRunner.o tests/minimal_test/MinimalTestRunner.cpp
