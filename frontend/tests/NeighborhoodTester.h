...
class NeighborhoodTester : public AbstractTester
{
    Q_OBJECT
public:
    NeighborhoodTester();
...
private:
    ...
    unsigned int mAttemptCount;

    bool ShouldAcceptNeighborhood(const NeighborhoodTaskResult &res);
    bool ValidateNeighborhoodResult(const NeighborhoodTaskResult &res);
