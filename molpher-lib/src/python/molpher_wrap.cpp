...
#define SWIGTYPE_p_BoolVector swig_types[0]
#define SWIGTYPE_p_ExplorationParameters swig_types[1]
#define SWIGTYPE_p_ExplorationTree swig_types[2]
#define SWIGTYPE_p_ExplorationTreeSnapshot swig_types[3]
#define SWIGTYPE_p_ExtendTreeOper swig_types[4]
#define SWIGTYPE_p_FilterMoprhsOper swig_types[5]
#define SWIGTYPE_p_FindLeavesOper swig_types[6]
#define SWIGTYPE_p_GenerateMoprhsOper swig_types[7]
#define SWIGTYPE_p_MoleculePointerVector swig_types[8]
#define SWIGTYPE_p_MoleculeVector swig_types[9]
...
#define SWIGTYPE_p_std__allocatorT_MolpherMol_t swig_types[29]
#define SWIGTYPE_p_std__allocatorT_bool_t swig_types[30]
...
#define SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t swig_types[35]
...
SWIGINTERN void std_vector_Sl_std_string_Sg__insert__SWIG_1(std::vector< std::string > *self,std::vector< std::string >::iterator pos,std::vector< std::string >::size_type n,std::vector< std::string >::value_type const &x){ self->insert(pos, n, x); }
  ...
  namespace swig {
    template <>  struct traits<MolpherMol > {
      typedef pointer_category category;
      static const char* type_name() { return"MolpherMol"; }
    };
  }


      namespace swig {
	template <>  struct traits<std::vector<MolpherMol, std::allocator< MolpherMol > > > {
	  typedef pointer_category category;
	  static const char* type_name() {
	    return "std::vector<" "MolpherMol" "," "std::allocator< MolpherMol >" " >";
	  }
	};
      }
    
SWIGINTERN swig::SwigPyIterator *std_vector_Sl_MolpherMol_Sg__iterator(std::vector< MolpherMol > *self,PyObject **PYTHON_SELF){
      return swig::make_output_iterator(self->begin(), self->begin(), self->end(), *PYTHON_SELF);
    }
SWIGINTERN bool std_vector_Sl_MolpherMol_Sg____nonzero__(std::vector< MolpherMol > const *self){
      return !(self->empty());
    }
SWIGINTERN bool std_vector_Sl_MolpherMol_Sg____bool__(std::vector< MolpherMol > const *self){
      return !(self->empty());
    }
SWIGINTERN std::vector< MolpherMol >::size_type std_vector_Sl_MolpherMol_Sg____len__(std::vector< MolpherMol > const *self){
      return self->size();
    }
SWIGINTERN std::vector< MolpherMol >::value_type std_vector_Sl_MolpherMol_Sg__pop(std::vector< MolpherMol > *self){
      if (self->size() == 0)
	throw std::out_of_range("pop from empty container");
      std::vector<MolpherMol,std::allocator< MolpherMol > >::value_type x = self->back();
      self->pop_back();
      return x;
    }
SWIGINTERN std::vector< MolpherMol,std::allocator< MolpherMol > > *std_vector_Sl_MolpherMol_Sg____getslice__(std::vector< MolpherMol > *self,std::vector< MolpherMol >::difference_type i,std::vector< MolpherMol >::difference_type j){
      return swig::getslice(self, i, j, 1);
    }
SWIGINTERN void std_vector_Sl_MolpherMol_Sg____setslice____SWIG_0(std::vector< MolpherMol > *self,std::vector< MolpherMol >::difference_type i,std::vector< MolpherMol >::difference_type j,std::vector< MolpherMol,std::allocator< MolpherMol > > const &v=std::vector< MolpherMol,std::allocator< MolpherMol > >()){
      swig::setslice(self, i, j, 1, v);
    }
SWIGINTERN void std_vector_Sl_MolpherMol_Sg____delslice__(std::vector< MolpherMol > *self,std::vector< MolpherMol >::difference_type i,std::vector< MolpherMol >::difference_type j){
      swig::delslice(self, i, j, 1);
    }
SWIGINTERN void std_vector_Sl_MolpherMol_Sg____delitem____SWIG_0(std::vector< MolpherMol > *self,std::vector< MolpherMol >::difference_type i){
      self->erase(swig::getpos(self,i));
    }
SWIGINTERN std::vector< MolpherMol,std::allocator< MolpherMol > > *std_vector_Sl_MolpherMol_Sg____getitem____SWIG_0(std::vector< MolpherMol > *self,PySliceObject *slice){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return NULL;
      ...
      PySlice_GetIndices(SWIGPY_SLICE_ARG(slice), (Py_ssize_t)self->size(), &i, &j, &step);
      std::vector<MolpherMol,std::allocator< MolpherMol > >::difference_type id = i;
      std::vector<MolpherMol,std::allocator< MolpherMol > >::difference_type jd = j;
      return swig::getslice(self, id, jd, step);
    }
SWIGINTERN void std_vector_Sl_MolpherMol_Sg____setitem____SWIG_0(std::vector< MolpherMol > *self,PySliceObject *slice,std::vector< MolpherMol,std::allocator< MolpherMol > > const &v){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return;
...
SWIGINTERN void std_vector_Sl_MolpherMol_Sg____setitem____SWIG_1(std::vector< MolpherMol > *self,PySliceObject *slice){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return;
...
SWIGINTERN void std_vector_Sl_MolpherMol_Sg____delitem____SWIG_1(std::vector< MolpherMol > *self,PySliceObject *slice){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return;
...
SWIGINTERN std::vector< MolpherMol >::value_type const &std_vector_Sl_MolpherMol_Sg____getitem____SWIG_1(std::vector< MolpherMol > const *self,std::vector< MolpherMol >::difference_type i){
      return *(swig::cgetpos(self, i));
    }
SWIGINTERN void std_vector_Sl_MolpherMol_Sg____setitem____SWIG_2(std::vector< MolpherMol > *self,std::vector< MolpherMol >::difference_type i,std::vector< MolpherMol >::value_type const &x){
      *(swig::getpos(self,i)) = x;
    }
SWIGINTERN void std_vector_Sl_MolpherMol_Sg__append(std::vector< MolpherMol > *self,std::vector< MolpherMol >::value_type const &x){
      self->push_back(x);
    }
SWIGINTERN std::vector< MolpherMol >::iterator std_vector_Sl_MolpherMol_Sg__erase__SWIG_0(std::vector< MolpherMol > *self,std::vector< MolpherMol >::iterator pos){ return self->erase(pos); }
...
SwigDirector_TreeOperation::SwigDirector_TreeOperation(PyObject *self, ExplorationTree &expTree): TreeOperation(expTree), Swig::Director(self) {
...
SWIGINTERN PyObject *_wrap_new_TreeOperation__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = obj0;
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_ExplorationTree,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_TreeOperation" "', argument " "2"" of type '" "ExplorationTree &""'"); 
  }
  if (!argp2) {
...
SWIGINTERN PyObject *_wrap_new_TreeOperation(PyObject *self, PyObject *args) {
  ...
  if (argc == 2) {
    ...
    if (_v) {
      void *vptr = 0;
      int res = SWIG_ConvertPtr(argv[1], &vptr, SWIGTYPE_p_ExplorationTree, 0);
      _v = SWIG_CheckState(res);
      if (_v) {
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'new_TreeOperation'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    TreeOperation::TreeOperation(ExplorationTree &)\n"
...
SWIGINTERN PyObject *_wrap_TreeOperation_setTree(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_ExplorationTree,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "TreeOperation_setTree" "', argument " "2"" of type '" "ExplorationTree &""'"); 
  }
  if (!argp2) {
...
SWIGINTERN PyObject *_wrap_new_GenerateMoprhsOper(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTree *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  GenerateMoprhsOper *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:new_GenerateMoprhsOper",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_ExplorationTree,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_GenerateMoprhsOper" "', argument " "1"" of type '" "ExplorationTree &""'"); 
  }
  if (!argp1) {
...
SWIGINTERN PyObject *_wrap_GenerateMoprhsOper___call__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  GenerateMoprhsOper *arg1 = (GenerateMoprhsOper *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:GenerateMoprhsOper___call__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_GenerateMoprhsOper, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_delete_GenerateMoprhsOper(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  GenerateMoprhsOper *arg1 = (GenerateMoprhsOper *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_GenerateMoprhsOper",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_GenerateMoprhsOper, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *GenerateMoprhsOper_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_GenerateMoprhsOper, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *_wrap_new_SortMoprhsOper(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTree *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  SortMoprhsOper *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:new_SortMoprhsOper",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_ExplorationTree,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_SortMoprhsOper" "', argument " "1"" of type '" "ExplorationTree &""'"); 
  }
  if (!argp1) {
...
SWIGINTERN PyObject *_wrap_SortMoprhsOper___call__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  SortMoprhsOper *arg1 = (SortMoprhsOper *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:SortMoprhsOper___call__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_SortMoprhsOper, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_delete_SortMoprhsOper(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  SortMoprhsOper *arg1 = (SortMoprhsOper *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_SortMoprhsOper",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_SortMoprhsOper, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *SortMoprhsOper_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_SortMoprhsOper, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *_wrap_new_FilterMoprhsOper__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTree *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  FilterMoprhsOper *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:new_FilterMoprhsOper",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_ExplorationTree,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_FilterMoprhsOper" "', argument " "1"" of type '" "ExplorationTree &""'"); 
  }
  if (!argp1) {
...
SWIGINTERN PyObject *_wrap_new_FilterMoprhsOper__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTree *arg1 = 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:new_FilterMoprhsOper",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_ExplorationTree,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_FilterMoprhsOper" "', argument " "1"" of type '" "ExplorationTree &""'"); 
  }
...
SWIGINTERN PyObject *_wrap_new_FilterMoprhsOper(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[3] = {
    0
  };
  ...
  if (argc == 1) {
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_FilterMoprhsOper__SWIG_0(self, args);
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_new_FilterMoprhsOper__SWIG_1(self, args);
      }
    }
  }
  
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'new_FilterMoprhsOper'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    FilterMoprhsOper::FilterMoprhsOper(ExplorationTree &)\n"
    "    FilterMoprhsOper::FilterMoprhsOper(ExplorationTree &,int)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_FilterMoprhsOper___call__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FilterMoprhsOper *arg1 = (FilterMoprhsOper *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:FilterMoprhsOper___call__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_FilterMoprhsOper, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_delete_FilterMoprhsOper(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FilterMoprhsOper *arg1 = (FilterMoprhsOper *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_FilterMoprhsOper",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_FilterMoprhsOper, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *FilterMoprhsOper_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_FilterMoprhsOper, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
SWIGINTERN PyObject *_wrap_new_ExtendTreeOper(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_ExplorationTree,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_ExtendTreeOper" "', argument " "1"" of type '" "ExplorationTree &""'"); 
  }
  if (!argp1) {
...
SWIGINTERN PyObject *_wrap_new_PruneTreeOper(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_ExplorationTree,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_PruneTreeOper" "', argument " "1"" of type '" "ExplorationTree &""'"); 
  }
  if (!argp1) {
...
SWIGINTERN PyObject *_wrap_new_MolpherMol__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:new_MolpherMol",&obj0,&obj1)) SWIG_fail;
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "new_MolpherMol" "', argument " "2"" of type '" "bool""'");
  } 
  arg2 = static_cast< bool >(val2);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (MolpherMol *)new MolpherMol(*arg1,arg2);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
...
SWIGINTERN PyObject *_wrap_new_MolpherMol(PyObject *self, PyObject *args) {
  ...
  if (argc == 1) {
    int _v;
    int res = SWIG_ConvertPtr(argv[0], 0, SWIGTYPE_p_MolpherMol, 0);
    _v = SWIG_CheckState(res);
    if (_v) {
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'new_MolpherMol'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    MolpherMol::MolpherMol(MolpherMolecule &,bool)\n"
...
SWIGINTERN PyObject *_wrap_MolpherMol_getDescendants(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_MolpherMol, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMol_getDescendants" "', argument " "1"" of type '" "MolpherMol *""'"); 
  }
  arg1 = reinterpret_cast< MolpherMol * >(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (std::set< std::string,std::less< std::string >,std::allocator< std::string > > *) &(arg1)->getDescendants();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
...
SWIGINTERN PyObject *_wrap_MolpherMol_getHistoricDescendants(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_MolpherMol, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMol_getHistoricDescendants" "', argument " "1"" of type '" "MolpherMol *""'"); 
  }
  arg1 = reinterpret_cast< MolpherMol * >(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (std::set< std::string,std::less< std::string >,std::allocator< std::string > > *) &(arg1)->getHistoricDescendants();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = swig::from(static_cast< std::set<std::string,std::less< std::string >,std::allocator< std::string > > >(*result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_MolpherMol_getItersWithoutDistImprovement(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_MolpherMol, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMol_getItersWithoutDistImprovement" "', argument " "1"" of type '" "MolpherMol *""'"); 
  }
  arg1 = reinterpret_cast< MolpherMol * >(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (unsigned int)(arg1)->getItersWithoutDistImprovement();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
...
SWIGINTERN PyObject *_wrap_MolpherMol_getSAScore(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_MolpherMol, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMol_getSAScore" "', argument " "1"" of type '" "MolpherMol *""'"); 
  }
  arg1 = reinterpret_cast< MolpherMol * >(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (double)(arg1)->getSAScore();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_double(static_cast< double >(result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_MolpherMol_getMolecularWeight(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_MolpherMol, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMol_getMolecularWeight" "', argument " "1"" of type '" "MolpherMol *""'"); 
  }
  arg1 = reinterpret_cast< MolpherMol * >(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (double)(arg1)->getMolecularWeight();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_double(static_cast< double >(result));
  return resultobj;
...
SWIGINTERN PyObject *MolpherMol_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_MolpherMol, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_valid(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationParameters_valid",&obj0)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_getTargetMol(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationParameters_getTargetMol",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_getTargetMol" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  try {
    {
      SWIG_PYTHON_THREAD_BEGIN_ALLOW;
      result = (MolpherMol *)(arg1)->getTargetMol();
      SWIG_PYTHON_THREAD_END_ALLOW;
    }
  }
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_getChemOperators(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationParameters_getChemOperators",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_getChemOperators" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  try {
    {
      SWIG_PYTHON_THREAD_BEGIN_ALLOW;
      result = (std::vector< std::string,std::allocator< std::string > > *) &(arg1)->getChemOperators();
      SWIG_PYTHON_THREAD_END_ALLOW;
    }
  }
  catch(std::runtime_error &_e) {
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_getFingerprint(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationParameters_getFingerprint",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_getFingerprint" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  try {
    {
      SWIG_PYTHON_THREAD_BEGIN_ALLOW;
      result = (arg1)->getFingerprint();
      SWIG_PYTHON_THREAD_END_ALLOW;
    }
  }
  catch(std::runtime_error &_e) {
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_getSimilarityCoef(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationParameters_getSimilarityCoef",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_getSimilarityCoef" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  try {
    {
      SWIG_PYTHON_THREAD_BEGIN_ALLOW;
      result = (arg1)->getSimilarityCoef();
      SWIG_PYTHON_THREAD_END_ALLOW;
    }
  }
  catch(std::runtime_error &_e) {
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_getMinAcceptableMolecularWeight(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationParameters_getMinAcceptableMolecularWeight",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_getMinAcceptableMolecularWeight" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (double)(arg1)->getMinAcceptableMolecularWeight();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_double(static_cast< double >(result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_getMaxAcceptableMolecularWeight(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationParameters_getMaxAcceptableMolecularWeight",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_getMaxAcceptableMolecularWeight" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (double)(arg1)->getMaxAcceptableMolecularWeight();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_double(static_cast< double >(result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_getCntCandidatesToKeep(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationParameters_getCntCandidatesToKeep",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_getCntCandidatesToKeep" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (int)(arg1)->getCntCandidatesToKeep();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_getCntCandidatesToKeepMax(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationParameters_getCntCandidatesToKeepMax",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_getCntCandidatesToKeepMax" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (int)(arg1)->getCntCandidatesToKeepMax();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_getCntMorphs(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationParameters_getCntMorphs",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_getCntMorphs" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (int)(arg1)->getCntMorphs();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_getCntMorphsInDepth(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationParameters_getCntMorphsInDepth",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_getCntMorphsInDepth" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (int)(arg1)->getCntMorphsInDepth();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_getDistToTargetDepthSwitch(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationParameters_getDistToTargetDepthSwitch",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_getDistToTargetDepthSwitch" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (double)(arg1)->getDistToTargetDepthSwitch();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_double(static_cast< double >(result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_getCntMaxMorphs(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationParameters_getCntMaxMorphs",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_getCntMaxMorphs" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (int)(arg1)->getCntMaxMorphs();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_getItThreshold(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationParameters_getItThreshold",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_getItThreshold" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (int)(arg1)->getItThreshold();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_setSourceMol__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  {
    ...
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ExplorationParameters_setSourceMol" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ExplorationParameters_setSourceMol" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    arg2 = ptr;
  }
  {
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_setTargetMol__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  std::string *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationParameters_setTargetMol",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_setTargetMol" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ExplorationParameters_setTargetMol" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ExplorationParameters_setTargetMol" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    arg2 = ptr;
  }
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    (arg1)->setTargetMol((std::string const &)*arg2);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_Py_Void();
  if (SWIG_IsNewObj(res2)) delete arg2;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_setTargetMol__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  MolpherMol *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_MolpherMol,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ExplorationParameters_setTargetMol" "', argument " "2"" of type '" "MolpherMol &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ExplorationParameters_setTargetMol" "', argument " "2"" of type '" "MolpherMol &""'"); 
  }
  arg2 = reinterpret_cast< MolpherMol * >(argp2);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    (arg1)->setTargetMol(*arg2);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_Py_Void();
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_setTargetMol(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[3] = {
    0
  };
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_ExplorationParameters_setTargetMol__SWIG_1(self, args);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_ExplorationParameters_setTargetMol__SWIG_0(self, args);
      }
    }
  }
  
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ExplorationParameters_setTargetMol'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    ExplorationParameters::setTargetMol(std::string const &)\n"
    "    ExplorationParameters::setTargetMol(MolpherMol &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ExplorationParameters_setChemOperators(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationParameters_setChemOperators",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_setChemOperators" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  {
    std::vector<std::string,std::allocator< std::string > > *ptr = (std::vector<std::string,std::allocator< std::string > > *)0;
    ...
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ExplorationParameters_setChemOperators" "', argument " "2"" of type '" "std::vector< std::string,std::allocator< std::string > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ExplorationParameters_setChemOperators" "', argument " "2"" of type '" "std::vector< std::string,std::allocator< std::string > > const &""'"); 
    }
    arg2 = ptr;
  }
  try {
    {
      SWIG_PYTHON_THREAD_BEGIN_ALLOW;
      (arg1)->setChemOperators((std::vector< std::string,std::allocator< std::string > > const &)*arg2);
      SWIG_PYTHON_THREAD_END_ALLOW;
    }
  }
  catch(std::runtime_error &_e) {
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_setFingerprint(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  std::string *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationParameters_setFingerprint",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_setFingerprint" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ExplorationParameters_setFingerprint" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ExplorationParameters_setFingerprint" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    arg2 = ptr;
  }
  try {
    {
      SWIG_PYTHON_THREAD_BEGIN_ALLOW;
      (arg1)->setFingerprint((std::string const &)*arg2);
      SWIG_PYTHON_THREAD_END_ALLOW;
    }
  }
  catch(std::runtime_error &_e) {
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_setSimilarityCoef(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  std::string *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationParameters_setSimilarityCoef",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_setSimilarityCoef" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ExplorationParameters_setSimilarityCoef" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ExplorationParameters_setSimilarityCoef" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    arg2 = ptr;
  }
  try {
    {
      SWIG_PYTHON_THREAD_BEGIN_ALLOW;
      (arg1)->setSimilarityCoef((std::string const &)*arg2);
      SWIG_PYTHON_THREAD_END_ALLOW;
    }
  }
  catch(std::runtime_error &_e) {
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_setMinAcceptableMolecularWeight(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  double arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationParameters_setMinAcceptableMolecularWeight",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_setMinAcceptableMolecularWeight" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  ecode2 = SWIG_AsVal_double(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ExplorationParameters_setMinAcceptableMolecularWeight" "', argument " "2"" of type '" "double""'");
  } 
  arg2 = static_cast< double >(val2);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    (arg1)->setMinAcceptableMolecularWeight(arg2);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_Py_Void();
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_setMaxAcceptableMolecularWeight(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  double arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationParameters_setMaxAcceptableMolecularWeight",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_setMaxAcceptableMolecularWeight" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  ecode2 = SWIG_AsVal_double(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ExplorationParameters_setMaxAcceptableMolecularWeight" "', argument " "2"" of type '" "double""'");
  } 
  arg2 = static_cast< double >(val2);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    (arg1)->setMaxAcceptableMolecularWeight(arg2);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_Py_Void();
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_setCntCandidatesToKeep(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationParameters_setCntCandidatesToKeep",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_setCntCandidatesToKeep" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ExplorationParameters_setCntCandidatesToKeep" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    (arg1)->setCntCandidatesToKeep(arg2);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_Py_Void();
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_setCntCandidatesToKeepMax(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationParameters_setCntCandidatesToKeepMax",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_setCntCandidatesToKeepMax" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ExplorationParameters_setCntCandidatesToKeepMax" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    (arg1)->setCntCandidatesToKeepMax(arg2);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_Py_Void();
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_setCntMorphs(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationParameters_setCntMorphs",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_setCntMorphs" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ExplorationParameters_setCntMorphs" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    (arg1)->setCntMorphs(arg2);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_Py_Void();
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_setCntMorphsInDepth(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationParameters_setCntMorphsInDepth",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_setCntMorphsInDepth" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ExplorationParameters_setCntMorphsInDepth" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    (arg1)->setCntMorphsInDepth(arg2);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_Py_Void();
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_setDistToTargetDepthSwitch(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  double arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationParameters_setDistToTargetDepthSwitch",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_setDistToTargetDepthSwitch" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  ecode2 = SWIG_AsVal_double(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ExplorationParameters_setDistToTargetDepthSwitch" "', argument " "2"" of type '" "double""'");
  } 
  arg2 = static_cast< double >(val2);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    (arg1)->setDistToTargetDepthSwitch(arg2);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_Py_Void();
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_setCntMaxMorphs(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationParameters_setCntMaxMorphs",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_setCntMaxMorphs" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ExplorationParameters_setCntMaxMorphs" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    (arg1)->setCntMaxMorphs(arg2);
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_Py_Void();
  return resultobj;
...
SWIGINTERN PyObject *_wrap_ExplorationParameters_setItThreshold(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationParameters_setItThreshold",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationParameters_setItThreshold" "', argument " "1"" of type '" "ExplorationParameters *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationParameters * >(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ExplorationParameters_setItThreshold" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
...
SWIGINTERN PyObject *_wrap_delete_ExplorationParameters(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationParameters *arg1 = (ExplorationParameters *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_ExplorationParameters",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationParameters, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *ExplorationParameters_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_ExplorationParameters, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *_wrap_ExplorationTreeSnapshot_load(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::string *arg1 = 0 ;
  int res1 = SWIG_OLDOBJ ;
  PyObject * obj0 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationTreeSnapshot_load",&obj0)) SWIG_fail;
  {
    ...
    res1 = SWIG_AsPtr_std_string(obj0, &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationTreeSnapshot_load" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ExplorationTreeSnapshot_load" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    arg1 = ptr;
  }
  try {
...
SWIGINTERN PyObject *_wrap_ExplorationTreeSnapshot_save(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTreeSnapshot *arg1 = (ExplorationTreeSnapshot *) 0 ;
  std::string *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int res2 = SWIG_OLDOBJ ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationTreeSnapshot_save",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationTreeSnapshot, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationTreeSnapshot_save" "', argument " "1"" of type '" "ExplorationTreeSnapshot *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationTreeSnapshot * >(argp1);
  {
    ...
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ExplorationTreeSnapshot_save" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ExplorationTreeSnapshot_save" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    arg2 = ptr;
  }
  {
...
SWIGINTERN PyObject *_wrap_delete_ExplorationTreeSnapshot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTreeSnapshot *arg1 = (ExplorationTreeSnapshot *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_ExplorationTreeSnapshot",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationTreeSnapshot, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *ExplorationTreeSnapshot_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_ExplorationTreeSnapshot, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *_wrap_MolpherMolVector_iterator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  PyObject **arg2 = (PyObject **) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  ...
  arg2 = &obj0;
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector_iterator",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector___nonzero__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector___nonzero__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector___bool__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector___bool__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector___len__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  std::vector< MolpherMol >::size_type result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector___len__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_pop(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  std::vector< MolpherMol >::value_type result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector_pop",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector_pop" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  try {
    {
  ...
  resultobj = SWIG_NewPointerObj((new std::vector< MolpherMol >::value_type(static_cast< const std::vector< MolpherMol >::value_type& >(result))), SWIGTYPE_p_MolpherMol, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_MolpherMolVector___getslice__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::difference_type arg2 ;
  std::vector< MolpherMol >::difference_type arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ptrdiff_t val2 ;
  int ecode2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:MolpherMolVector___getslice__",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector___getslice__" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "MolpherMolVector___getslice__" "', argument " "2"" of type '" "std::vector< MolpherMol >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< MolpherMol >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "MolpherMolVector___getslice__" "', argument " "3"" of type '" "std::vector< MolpherMol >::difference_type""'");
  } 
...
SWIGINTERN PyObject *_wrap_MolpherMolVector___setslice____SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::difference_type arg2 ;
  std::vector< MolpherMol >::difference_type arg3 ;
  std::vector< MolpherMol,std::allocator< MolpherMol > > *arg4 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ptrdiff_t val2 ;
  int ecode2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:MolpherMolVector___setslice__",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector___setslice__" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "MolpherMolVector___setslice__" "', argument " "2"" of type '" "std::vector< MolpherMol >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< MolpherMol >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "MolpherMolVector___setslice__" "', argument " "3"" of type '" "std::vector< MolpherMol >::difference_type""'");
  } 
  arg3 = static_cast< std::vector< MolpherMol >::difference_type >(val3);
  {
    std::vector<MolpherMol,std::allocator< MolpherMol > > *ptr = (std::vector<MolpherMol,std::allocator< MolpherMol > > *)0;
    res4 = swig::asptr(obj3, &ptr);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "MolpherMolVector___setslice__" "', argument " "4"" of type '" "std::vector< MolpherMol,std::allocator< MolpherMol > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MolpherMolVector___setslice__" "', argument " "4"" of type '" "std::vector< MolpherMol,std::allocator< MolpherMol > > const &""'"); 
    }
    arg4 = ptr;
  }
  try {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector___setslice____SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::difference_type arg2 ;
  std::vector< MolpherMol >::difference_type arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:MolpherMolVector___setslice__",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector___setslice__" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
...
SWIGINTERN PyObject *_wrap_MolpherMolVector___setslice__(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[5] = {
    0
  };
  ...
  if (argc == 3) {
    int _v;
    int res = swig::asptr(argv[0], (std::vector<MolpherMol,std::allocator< MolpherMol > >**)(0));
    _v = SWIG_CheckState(res);
    if (_v) {
      {
        int res = SWIG_AsVal_ptrdiff_t(argv[1], NULL);
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_MolpherMolVector___setslice____SWIG_1(self, args);
        }
      }
    }
  }
  if (argc == 4) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          int res = swig::asptr(argv[3], (std::vector<MolpherMol,std::allocator< MolpherMol > >**)(0));
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_MolpherMolVector___setslice____SWIG_0(self, args);
          }
        }
      }
    }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'MolpherMolVector___setslice__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< MolpherMol >::__setslice__(std::vector< MolpherMol >::difference_type,std::vector< MolpherMol >::difference_type,std::vector< MolpherMol,std::allocator< MolpherMol > > const &)\n"
    "    std::vector< MolpherMol >::__setslice__(std::vector< MolpherMol >::difference_type,std::vector< MolpherMol >::difference_type)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_MolpherMolVector___delslice__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::difference_type arg2 ;
  std::vector< MolpherMol >::difference_type arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:MolpherMolVector___delslice__",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector___delslice__" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "MolpherMolVector___delslice__" "', argument " "2"" of type '" "std::vector< MolpherMol >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< MolpherMol >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "MolpherMolVector___delslice__" "', argument " "3"" of type '" "std::vector< MolpherMol >::difference_type""'");
  } 
  arg3 = static_cast< std::vector< MolpherMol >::difference_type >(val3);
  try {
    {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector___delitem____SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::difference_type arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MolpherMolVector___delitem__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector___delitem__" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "MolpherMolVector___delitem__" "', argument " "2"" of type '" "std::vector< MolpherMol >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< MolpherMol >::difference_type >(val2);
  try {
    {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector___getitem____SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MolpherMolVector___getitem__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector___getitem__" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  {
    if (!PySlice_Check(obj1)) {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "MolpherMolVector___getitem__" "', argument " "2"" of type '" "PySliceObject *""'");
    }
    arg2 = (PySliceObject *) obj1;
  }
  try {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector___setitem____SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
  std::vector< MolpherMol,std::allocator< MolpherMol > > *arg3 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int res3 = SWIG_OLDOBJ ;
  PyObject * obj0 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:MolpherMolVector___setitem__",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector___setitem__" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  {
    if (!PySlice_Check(obj1)) {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "MolpherMolVector___setitem__" "', argument " "2"" of type '" "PySliceObject *""'");
    }
    arg2 = (PySliceObject *) obj1;
  }
  {
    ...
    res3 = swig::asptr(obj2, &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "MolpherMolVector___setitem__" "', argument " "3"" of type '" "std::vector< MolpherMol,std::allocator< MolpherMol > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MolpherMolVector___setitem__" "', argument " "3"" of type '" "std::vector< MolpherMol,std::allocator< MolpherMol > > const &""'"); 
    }
    arg3 = ptr;
  }
  try {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector___setitem____SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MolpherMolVector___setitem__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector___setitem__" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
...
SWIGINTERN PyObject *_wrap_MolpherMolVector___delitem____SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  PySliceObject *arg2 = (PySliceObject *) 0 ;
  void *argp1 = 0 ;
  ...
  {
    if (!PySlice_Check(obj1)) {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "MolpherMolVector___delitem__" "', argument " "2"" of type '" "PySliceObject *""'");
    }
    arg2 = (PySliceObject *) obj1;
  }
  try {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector___delitem__(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[3] = {
    0
  };
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_MolpherMolVector___delitem____SWIG_1(self, args);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_MolpherMolVector___delitem____SWIG_0(self, args);
      }
    }
  }
  
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'MolpherMolVector___delitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< MolpherMol >::__delitem__(std::vector< MolpherMol >::difference_type)\n"
    "    std::vector< MolpherMol >::__delitem__(PySliceObject *)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_MolpherMolVector___getitem____SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::difference_type arg2 ;
  void *argp1 = 0 ;
  ...
  PyObject * obj0 = 0 ;
  PyObject * obj1 = 0 ;
  std::vector< MolpherMol >::value_type *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"OO:MolpherMolVector___getitem__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector___getitem__" "', argument " "1"" of type '" "std::vector< MolpherMol > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "MolpherMolVector___getitem__" "', argument " "2"" of type '" "std::vector< MolpherMol >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< MolpherMol >::difference_type >(val2);
  try {
    {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector___getitem__(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[3] = {
    0
  };
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_MolpherMolVector___getitem____SWIG_0(self, args);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_MolpherMolVector___getitem____SWIG_1(self, args);
      }
    }
  }
  
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'MolpherMolVector___getitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< MolpherMol >::__getitem__(PySliceObject *)\n"
    "    std::vector< MolpherMol >::__getitem__(std::vector< MolpherMol >::difference_type) const\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_MolpherMolVector___setitem____SWIG_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::difference_type arg2 ;
  std::vector< MolpherMol >::value_type *arg3 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ptrdiff_t val2 ;
  int ecode2 = 0 ;
  ...
  ecode2 = SWIG_AsVal_ptrdiff_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "MolpherMolVector___setitem__" "', argument " "2"" of type '" "std::vector< MolpherMol >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< MolpherMol >::difference_type >(val2);
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_MolpherMol,  0  | 0);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "MolpherMolVector___setitem__" "', argument " "3"" of type '" "std::vector< MolpherMol >::value_type const &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MolpherMolVector___setitem__" "', argument " "3"" of type '" "std::vector< MolpherMol >::value_type const &""'"); 
  }
...
SWIGINTERN PyObject *_wrap_MolpherMolVector___setitem__(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[4] = {
    0
  };
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_MolpherMolVector___setitem____SWIG_1(self, args);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        int res = swig::asptr(argv[2], (std::vector<MolpherMol,std::allocator< MolpherMol > >**)(0));
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_MolpherMolVector___setitem____SWIG_0(self, args);
        }
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        int res = SWIG_ConvertPtr(argv[2], 0, SWIGTYPE_p_MolpherMol, 0);
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_MolpherMolVector___setitem____SWIG_2(self, args);
        }
      }
    }
  }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'MolpherMolVector___setitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< MolpherMol >::__setitem__(PySliceObject *,std::vector< MolpherMol,std::allocator< MolpherMol > > const &)\n"
    "    std::vector< MolpherMol >::__setitem__(PySliceObject *)\n"
    "    std::vector< MolpherMol >::__setitem__(std::vector< MolpherMol >::difference_type,std::vector< MolpherMol >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_MolpherMolVector_append(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::value_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MolpherMolVector_append",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector_append" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_MolpherMol,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MolpherMolVector_append" "', argument " "2"" of type '" "std::vector< MolpherMol >::value_type const &""'"); 
  }
  if (!argp2) {
...
SWIGINTERN PyObject *_wrap_new_MolpherMolVector__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
...
SWIGINTERN PyObject *_wrap_new_MolpherMolVector__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = 0 ;
  int res1 = SWIG_OLDOBJ ;
  PyObject * obj0 = 0 ;
  std::vector< MolpherMol > *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:new_MolpherMolVector",&obj0)) SWIG_fail;
  {
    std::vector<MolpherMol,std::allocator< MolpherMol > > *ptr = (std::vector<MolpherMol,std::allocator< MolpherMol > > *)0;
    res1 = swig::asptr(obj0, &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_MolpherMolVector" "', argument " "1"" of type '" "std::vector< MolpherMol > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_MolpherMolVector" "', argument " "1"" of type '" "std::vector< MolpherMol > const &""'"); 
    }
    arg1 = ptr;
  }
  {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_empty(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector_empty",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_size(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector_size",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_clear(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector_clear",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_swap(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol > *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MolpherMolVector_swap",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector_swap" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MolpherMolVector_swap" "', argument " "2"" of type '" "std::vector< MolpherMol > &""'"); 
  }
  if (!argp2) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_get_allocator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  SwigValueWrapper< std::allocator< MolpherMol > > result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector_get_allocator",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_begin(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  std::vector< MolpherMol >::iterator result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector_begin",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_end(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector_end",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_rbegin(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  std::vector< MolpherMol >::reverse_iterator result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector_rbegin",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_rend(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector_rend",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_new_MolpherMolVector__SWIG_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol >::size_type arg1 ;
  size_t val1 ;
  int ecode1 = 0 ;
  PyObject * obj0 = 0 ;
  std::vector< MolpherMol > *result = 0 ;
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_pop_back(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector_pop_back",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_resize__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::size_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  size_t val2 ;
  int ecode2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MolpherMolVector_resize",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector_resize" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_erase__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::iterator arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MolpherMolVector_erase",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector_erase" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, SWIG_as_voidptrptr(&iter2), swig::SwigPyIterator::descriptor(), 0);
  if (!SWIG_IsOK(res2) || !iter2) {
    ...
    swig::SwigPyIterator_T<std::vector< MolpherMol >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::vector< MolpherMol >::iterator > *>(iter2);
    if (iter_t) {
      arg2 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "MolpherMolVector_erase" "', argument " "2"" of type '" "std::vector< MolpherMol >::iterator""'");
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_erase__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::iterator arg2 ;
  std::vector< MolpherMol >::iterator arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:MolpherMolVector_erase",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector_erase" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  ...
  if (!SWIG_IsOK(res3) || !iter3) {
    ...
    swig::SwigPyIterator_T<std::vector< MolpherMol >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::vector< MolpherMol >::iterator > *>(iter3);
    if (iter_t) {
      arg3 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "MolpherMolVector_erase" "', argument " "3"" of type '" "std::vector< MolpherMol >::iterator""'");
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_erase(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[4] = {
    0
  };
  ...
  if (argc == 2) {
    ...
    if (_v) {
      swig::SwigPyIterator *iter = 0;
      int res = SWIG_ConvertPtr(argv[1], SWIG_as_voidptrptr(&iter), swig::SwigPyIterator::descriptor(), 0);
      _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::SwigPyIterator_T<std::vector< MolpherMol >::iterator > *>(iter) != 0));
      if (_v) {
        return _wrap_MolpherMolVector_erase__SWIG_0(self, args);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::SwigPyIterator_T<std::vector< MolpherMol >::iterator > *>(iter) != 0));
        if (_v) {
          return _wrap_MolpherMolVector_erase__SWIG_1(self, args);
        }
      }
    }
  }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'MolpherMolVector_erase'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< MolpherMol >::erase(std::vector< MolpherMol >::iterator)\n"
    "    std::vector< MolpherMol >::erase(std::vector< MolpherMol >::iterator,std::vector< MolpherMol >::iterator)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_new_MolpherMolVector__SWIG_3(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol >::size_type arg1 ;
  std::vector< MolpherMol >::value_type *arg2 = 0 ;
  size_t val1 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:new_MolpherMolVector",&obj0,&obj1)) SWIG_fail;
  ecode1 = SWIG_AsVal_size_t(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "new_MolpherMolVector" "', argument " "1"" of type '" "std::vector< MolpherMol >::size_type""'");
  } 
  ...
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_MolpherMol,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_MolpherMolVector" "', argument " "2"" of type '" "std::vector< MolpherMol >::value_type const &""'"); 
  }
  if (!argp2) {
...
SWIGINTERN PyObject *_wrap_new_MolpherMolVector(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[3] = {
    0
  };
  ...
  if (argc == 0) {
    return _wrap_new_MolpherMolVector__SWIG_0(self, args);
  }
  if (argc == 1) {
    int _v;
    {
    ...
    if (_v) {
      return _wrap_new_MolpherMolVector__SWIG_2(self, args);
    }
  }
  if (argc == 1) {
    int _v;
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_MolpherMolVector__SWIG_1(self, args);
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      int res = SWIG_ConvertPtr(argv[1], 0, SWIGTYPE_p_MolpherMol, 0);
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_new_MolpherMolVector__SWIG_3(self, args);
      }
    }
  }
  
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'new_MolpherMolVector'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< MolpherMol >::vector()\n"
    "    std::vector< MolpherMol >::vector(std::vector< MolpherMol > const &)\n"
    "    std::vector< MolpherMol >::vector(std::vector< MolpherMol >::size_type)\n"
    "    std::vector< MolpherMol >::vector(std::vector< MolpherMol >::size_type,std::vector< MolpherMol >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_MolpherMolVector_push_back(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::value_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MolpherMolVector_push_back",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector_push_back" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_MolpherMol,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MolpherMolVector_push_back" "', argument " "2"" of type '" "std::vector< MolpherMol >::value_type const &""'"); 
  }
  if (!argp2) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_front(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector_front",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_back(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector_back",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_assign(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::size_type arg2 ;
  std::vector< MolpherMol >::value_type *arg3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:MolpherMolVector_assign",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector_assign" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "MolpherMolVector_assign" "', argument " "2"" of type '" "std::vector< MolpherMol >::size_type""'");
  } 
  arg2 = static_cast< std::vector< MolpherMol >::size_type >(val2);
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_MolpherMol,  0  | 0);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "MolpherMolVector_assign" "', argument " "3"" of type '" "std::vector< MolpherMol >::value_type const &""'"); 
  }
  if (!argp3) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_resize__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::size_type arg2 ;
  std::vector< MolpherMol >::value_type *arg3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:MolpherMolVector_resize",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector_resize" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  ...
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_MolpherMol,  0  | 0);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "MolpherMolVector_resize" "', argument " "3"" of type '" "std::vector< MolpherMol >::value_type const &""'"); 
  }
  if (!argp3) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_resize(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[4] = {
    0
  };
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_MolpherMolVector_resize__SWIG_0(self, args);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_MolpherMolVector_resize__SWIG_1(self, args);
        }
      }
    }
  }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'MolpherMolVector_resize'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< MolpherMol >::resize(std::vector< MolpherMol >::size_type)\n"
    "    std::vector< MolpherMol >::resize(std::vector< MolpherMol >::size_type,std::vector< MolpherMol >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_MolpherMolVector_insert__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::iterator arg2 ;
  std::vector< MolpherMol >::value_type *arg3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:MolpherMolVector_insert",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector_insert" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, SWIG_as_voidptrptr(&iter2), swig::SwigPyIterator::descriptor(), 0);
  if (!SWIG_IsOK(res2) || !iter2) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "MolpherMolVector_insert" "', argument " "2"" of type '" "std::vector< MolpherMol >::iterator""'");
  } else {
    swig::SwigPyIterator_T<std::vector< MolpherMol >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::vector< MolpherMol >::iterator > *>(iter2);
    if (iter_t) {
      arg2 = iter_t->get_current();
  ...
  res3 = SWIG_ConvertPtr(obj2, &argp3, SWIGTYPE_p_MolpherMol,  0  | 0);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "MolpherMolVector_insert" "', argument " "3"" of type '" "std::vector< MolpherMol >::value_type const &""'"); 
  }
  if (!argp3) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_insert__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::iterator arg2 ;
  std::vector< MolpherMol >::size_type arg3 ;
  std::vector< MolpherMol >::value_type *arg4 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:MolpherMolVector_insert",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector_insert" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  ...
  ecode3 = SWIG_AsVal_size_t(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "MolpherMolVector_insert" "', argument " "3"" of type '" "std::vector< MolpherMol >::size_type""'");
  } 
  arg3 = static_cast< std::vector< MolpherMol >::size_type >(val3);
  res4 = SWIG_ConvertPtr(obj3, &argp4, SWIGTYPE_p_MolpherMol,  0  | 0);
  if (!SWIG_IsOK(res4)) {
    SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "MolpherMolVector_insert" "', argument " "4"" of type '" "std::vector< MolpherMol >::value_type const &""'"); 
  }
  if (!argp4) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_insert(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[5] = {
    0
  };
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_MolpherMolVector_insert__SWIG_0(self, args);
        }
      }
    }
  }
  if (argc == 4) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          int res = SWIG_ConvertPtr(argv[3], 0, SWIGTYPE_p_MolpherMol, 0);
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_MolpherMolVector_insert__SWIG_1(self, args);
          }
        }
      }
    }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'MolpherMolVector_insert'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< MolpherMol >::insert(std::vector< MolpherMol >::iterator,std::vector< MolpherMol >::value_type const &)\n"
    "    std::vector< MolpherMol >::insert(std::vector< MolpherMol >::iterator,std::vector< MolpherMol >::size_type,std::vector< MolpherMol >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_MolpherMolVector_reserve(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  std::vector< MolpherMol >::size_type arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MolpherMolVector_reserve",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MolpherMolVector_reserve" "', argument " "1"" of type '" "std::vector< MolpherMol > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< MolpherMol > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
...
SWIGINTERN PyObject *_wrap_MolpherMolVector_capacity(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MolpherMolVector_capacity",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_delete_MolpherMolVector(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< MolpherMol > *arg1 = (std::vector< MolpherMol > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_MolpherMolVector",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *MolpherMolVector_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
SWIGINTERN PyObject *_wrap_ExplorationTree_createFromSnapshot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTreeSnapshot *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  ExplorationTree *result = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationTree_createFromSnapshot" "', argument " "1"" of type '" "ExplorationTreeSnapshot &""'"); 
  }
  if (!argp1) {
...
SWIGINTERN PyObject *_wrap_new_ExplorationTree__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::string *arg1 = 0 ;
  int res1 = SWIG_OLDOBJ ;
  PyObject * obj0 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:new_ExplorationTree",&obj0)) SWIG_fail;
  {
    std::string *ptr = (std::string *)0;
    res1 = SWIG_AsPtr_std_string(obj0, &ptr);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_new_ExplorationTree__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:new_ExplorationTree",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_ExplorationParameters,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_ExplorationTree" "', argument " "1"" of type '" "ExplorationParameters &""'"); 
  }
  if (!argp1) {
...
SWIGINTERN PyObject *_wrap_ExplorationTree_createSnapshot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
...
SWIGINTERN PyObject *_wrap_ExplorationTree_runOperation(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTree *arg1 = (ExplorationTree *) 0 ;
  TreeOperation *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationTree_runOperation",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationTree, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationTree_runOperation" "', argument " "1"" of type '" "ExplorationTree *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationTree * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_TreeOperation,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ExplorationTree_runOperation" "', argument " "2"" of type '" "TreeOperation &""'"); 
  }
  if (!argp2) {
...
SWIGINTERN PyObject *_wrap_ExplorationTree_fetchLeaves(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTree *arg1 = (ExplorationTree *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_ExplorationTree_hasMol(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTree *arg1 = (ExplorationTree *) 0 ;
  std::string *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationTree_hasMol",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationTree, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationTree_hasMol" "', argument " "1"" of type '" "ExplorationTree *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationTree * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ExplorationTree_hasMol" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "ExplorationTree_hasMol" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    arg2 = ptr;
  }
  {
...
SWIGINTERN PyObject *_wrap_ExplorationTree_sortMorphs(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTree *arg1 = (ExplorationTree *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationTree_sortMorphs",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationTree, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_ExplorationTree_filterMorphs__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTree *arg1 = (ExplorationTree *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationTree_filterMorphs",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationTree, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_ExplorationTree_filterMorphs__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTree *arg1 = (ExplorationTree *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationTree_filterMorphs",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationTree, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationTree_filterMorphs" "', argument " "1"" of type '" "ExplorationTree *""'"); 
  }
...
SWIGINTERN PyObject *_wrap_ExplorationTree_filterMorphs(PyObject *self, PyObject *args) {
  int argc;
  PyObject *argv[3] = {
    0
  };
  ...
  if (argc == 1) {
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_ExplorationTree_filterMorphs__SWIG_0(self, args);
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_ExplorationTree_filterMorphs__SWIG_1(self, args);
      }
    }
  }
  
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'ExplorationTree_filterMorphs'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    ExplorationTree::filterMorphs()\n"
    "    ExplorationTree::filterMorphs(int)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_ExplorationTree_extend(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTree *arg1 = (ExplorationTree *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationTree_extend",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationTree, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_ExplorationTree_prune(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTree *arg1 = (ExplorationTree *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationTree_prune",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationTree, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_ExplorationTree_getParams(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ExplorationTree_getParams",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationTree, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationTree_getParams" "', argument " "1"" of type '" "ExplorationTree *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationTree * >(argp1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
    result = (ExplorationParameters *) &(arg1)->getParams();
    SWIG_PYTHON_THREAD_END_ALLOW;
  }
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_ExplorationParameters, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_ExplorationTree_getCandidateMorphsMask(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTree *arg1 = (ExplorationTree *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_ExplorationTree_setParams(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTree *arg1 = (ExplorationTree *) 0 ;
  ExplorationParameters *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ExplorationTree_setParams",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationTree, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExplorationTree_setParams" "', argument " "1"" of type '" "ExplorationTree *""'"); 
  }
  arg1 = reinterpret_cast< ExplorationTree * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_ExplorationParameters,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ExplorationTree_setParams" "', argument " "2"" of type '" "ExplorationParameters &""'"); 
  }
  if (!argp2) {
...
SWIGINTERN PyObject *_wrap_delete_ExplorationTree(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ExplorationTree *arg1 = (ExplorationTree *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_ExplorationTree",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ExplorationTree, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *ExplorationTree_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_ExplorationTree, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"new_GenerateMoprhsOper", _wrap_new_GenerateMoprhsOper, METH_VARARGS, NULL},
	 { (char *)"GenerateMoprhsOper___call__", _wrap_GenerateMoprhsOper___call__, METH_VARARGS, NULL},
	 { (char *)"delete_GenerateMoprhsOper", _wrap_delete_GenerateMoprhsOper, METH_VARARGS, NULL},
	 { (char *)"GenerateMoprhsOper_swigregister", GenerateMoprhsOper_swigregister, METH_VARARGS, NULL},
	 { (char *)"new_SortMoprhsOper", _wrap_new_SortMoprhsOper, METH_VARARGS, NULL},
	 { (char *)"SortMoprhsOper___call__", _wrap_SortMoprhsOper___call__, METH_VARARGS, NULL},
	 { (char *)"delete_SortMoprhsOper", _wrap_delete_SortMoprhsOper, METH_VARARGS, NULL},
	 { (char *)"SortMoprhsOper_swigregister", SortMoprhsOper_swigregister, METH_VARARGS, NULL},
	 { (char *)"new_FilterMoprhsOper", _wrap_new_FilterMoprhsOper, METH_VARARGS, NULL},
	 { (char *)"FilterMoprhsOper___call__", _wrap_FilterMoprhsOper___call__, METH_VARARGS, NULL},
	 { (char *)"delete_FilterMoprhsOper", _wrap_delete_FilterMoprhsOper, METH_VARARGS, NULL},
	 { (char *)"FilterMoprhsOper_swigregister", FilterMoprhsOper_swigregister, METH_VARARGS, NULL},
	 ...
	 { (char *)"ExplorationParameters_getSourceMol", _wrap_ExplorationParameters_getSourceMol, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_getTargetMol", _wrap_ExplorationParameters_getTargetMol, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_getChemOperators", _wrap_ExplorationParameters_getChemOperators, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_getFingerprint", _wrap_ExplorationParameters_getFingerprint, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_getSimilarityCoef", _wrap_ExplorationParameters_getSimilarityCoef, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_getMinAcceptableMolecularWeight", _wrap_ExplorationParameters_getMinAcceptableMolecularWeight, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_getMaxAcceptableMolecularWeight", _wrap_ExplorationParameters_getMaxAcceptableMolecularWeight, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_getCntCandidatesToKeep", _wrap_ExplorationParameters_getCntCandidatesToKeep, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_getCntCandidatesToKeepMax", _wrap_ExplorationParameters_getCntCandidatesToKeepMax, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_getCntMorphs", _wrap_ExplorationParameters_getCntMorphs, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_getCntMorphsInDepth", _wrap_ExplorationParameters_getCntMorphsInDepth, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_getDistToTargetDepthSwitch", _wrap_ExplorationParameters_getDistToTargetDepthSwitch, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_getCntMaxMorphs", _wrap_ExplorationParameters_getCntMaxMorphs, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_getItThreshold", _wrap_ExplorationParameters_getItThreshold, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_setSourceMol", _wrap_ExplorationParameters_setSourceMol, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_setTargetMol", _wrap_ExplorationParameters_setTargetMol, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_setChemOperators", _wrap_ExplorationParameters_setChemOperators, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_setFingerprint", _wrap_ExplorationParameters_setFingerprint, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_setSimilarityCoef", _wrap_ExplorationParameters_setSimilarityCoef, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_setMinAcceptableMolecularWeight", _wrap_ExplorationParameters_setMinAcceptableMolecularWeight, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_setMaxAcceptableMolecularWeight", _wrap_ExplorationParameters_setMaxAcceptableMolecularWeight, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_setCntCandidatesToKeep", _wrap_ExplorationParameters_setCntCandidatesToKeep, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_setCntCandidatesToKeepMax", _wrap_ExplorationParameters_setCntCandidatesToKeepMax, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_setCntMorphs", _wrap_ExplorationParameters_setCntMorphs, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_setCntMorphsInDepth", _wrap_ExplorationParameters_setCntMorphsInDepth, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_setDistToTargetDepthSwitch", _wrap_ExplorationParameters_setDistToTargetDepthSwitch, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_setCntMaxMorphs", _wrap_ExplorationParameters_setCntMaxMorphs, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_setItThreshold", _wrap_ExplorationParameters_setItThreshold, METH_VARARGS, NULL},
	 { (char *)"delete_ExplorationParameters", _wrap_delete_ExplorationParameters, METH_VARARGS, NULL},
	 { (char *)"ExplorationParameters_swigregister", ExplorationParameters_swigregister, METH_VARARGS, NULL},
	 { (char *)"ExplorationTreeSnapshot_load", _wrap_ExplorationTreeSnapshot_load, METH_VARARGS, NULL},
	 { (char *)"ExplorationTreeSnapshot_save", _wrap_ExplorationTreeSnapshot_save, METH_VARARGS, NULL},
	 { (char *)"delete_ExplorationTreeSnapshot", _wrap_delete_ExplorationTreeSnapshot, METH_VARARGS, NULL},
	 { (char *)"ExplorationTreeSnapshot_swigregister", ExplorationTreeSnapshot_swigregister, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_iterator", _wrap_MolpherMolVector_iterator, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector___nonzero__", _wrap_MolpherMolVector___nonzero__, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector___bool__", _wrap_MolpherMolVector___bool__, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector___len__", _wrap_MolpherMolVector___len__, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_pop", _wrap_MolpherMolVector_pop, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector___getslice__", _wrap_MolpherMolVector___getslice__, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector___setslice__", _wrap_MolpherMolVector___setslice__, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector___delslice__", _wrap_MolpherMolVector___delslice__, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector___delitem__", _wrap_MolpherMolVector___delitem__, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector___getitem__", _wrap_MolpherMolVector___getitem__, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector___setitem__", _wrap_MolpherMolVector___setitem__, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_append", _wrap_MolpherMolVector_append, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_empty", _wrap_MolpherMolVector_empty, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_size", _wrap_MolpherMolVector_size, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_clear", _wrap_MolpherMolVector_clear, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_swap", _wrap_MolpherMolVector_swap, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_get_allocator", _wrap_MolpherMolVector_get_allocator, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_begin", _wrap_MolpherMolVector_begin, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_end", _wrap_MolpherMolVector_end, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_rbegin", _wrap_MolpherMolVector_rbegin, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_rend", _wrap_MolpherMolVector_rend, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_pop_back", _wrap_MolpherMolVector_pop_back, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_erase", _wrap_MolpherMolVector_erase, METH_VARARGS, NULL},
	 { (char *)"new_MolpherMolVector", _wrap_new_MolpherMolVector, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_push_back", _wrap_MolpherMolVector_push_back, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_front", _wrap_MolpherMolVector_front, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_back", _wrap_MolpherMolVector_back, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_assign", _wrap_MolpherMolVector_assign, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_resize", _wrap_MolpherMolVector_resize, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_insert", _wrap_MolpherMolVector_insert, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_reserve", _wrap_MolpherMolVector_reserve, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_capacity", _wrap_MolpherMolVector_capacity, METH_VARARGS, NULL},
	 { (char *)"delete_MolpherMolVector", _wrap_delete_MolpherMolVector, METH_VARARGS, NULL},
	 { (char *)"MolpherMolVector_swigregister", MolpherMolVector_swigregister, METH_VARARGS, NULL},
	 ...
	 { (char *)"ExplorationTree_createFromSnapshot", _wrap_ExplorationTree_createFromSnapshot, METH_VARARGS, NULL},
	 { (char *)"new_ExplorationTree", _wrap_new_ExplorationTree, METH_VARARGS, NULL},
	 { (char *)"ExplorationTree_createSnapshot", _wrap_ExplorationTree_createSnapshot, METH_VARARGS, NULL},
	 { (char *)"ExplorationTree_runOperation", _wrap_ExplorationTree_runOperation, METH_VARARGS, NULL},
...
static void *_p_GenerateMoprhsOperTo_p_TreeOperation(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((TreeOperation *)  ((GenerateMoprhsOper *) x));
}
static void *_p_SortMoprhsOperTo_p_TreeOperation(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((TreeOperation *)  ((SortMoprhsOper *) x));
}
static void *_p_FilterMoprhsOperTo_p_TreeOperation(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((TreeOperation *)  ((FilterMoprhsOper *) x));
}
...
static swig_type_info _swigt__p_ExplorationTreeSnapshot = {"_p_ExplorationTreeSnapshot", "ExplorationTreeSnapshot *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ExtendTreeOper = {"_p_ExtendTreeOper", "ExtendTreeOper *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_FilterMoprhsOper = {"_p_FilterMoprhsOper", "FilterMoprhsOper *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_FindLeavesOper = {"_p_FindLeavesOper", "FindLeavesOper *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_GenerateMoprhsOper = {"_p_GenerateMoprhsOper", "GenerateMoprhsOper *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_MoleculePointerVector = {"_p_MoleculePointerVector", "MoleculePointerVector *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_MoleculeVector = {"_p_MoleculeVector", "MoleculeVector *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__allocatorT_MolpherMol_t = {"_p_std__allocatorT_MolpherMol_t", "std::vector< MolpherMol >::allocator_type *|std::allocator< MolpherMol > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t = {"_p_std__vectorT_MolpherMol_std__allocatorT_MolpherMol_t_t", "std::vector< MolpherMol,std::allocator< MolpherMol > > *|std::vector< MolpherMol > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p_BoolVector,
  &_swigt__p_ExplorationParameters,
  &_swigt__p_ExplorationTree,
  &_swigt__p_ExplorationTreeSnapshot,
  &_swigt__p_ExtendTreeOper,
  &_swigt__p_FilterMoprhsOper,
  &_swigt__p_FindLeavesOper,
  &_swigt__p_GenerateMoprhsOper,
  &_swigt__p_MoleculePointerVector,
  &_swigt__p_MoleculeVector,
  ...
  &_swigt__p_reference,
  &_swigt__p_size_type,
  &_swigt__p_std__allocatorT_MolpherMol_t,
...
static swig_cast_info _swigc__p_BoolVector[] = {  {&_swigt__p_BoolVector, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ExplorationParameters[] = {  {&_swigt__p_ExplorationParameters, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ExplorationTree[] = {  {&_swigt__p_ExplorationTree, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ExplorationTreeSnapshot[] = {  {&_swigt__p_ExplorationTreeSnapshot, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ExtendTreeOper[] = {  {&_swigt__p_ExtendTreeOper, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FilterMoprhsOper[] = {  {&_swigt__p_FilterMoprhsOper, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FindLeavesOper[] = {  {&_swigt__p_FindLeavesOper, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_GenerateMoprhsOper[] = {  {&_swigt__p_GenerateMoprhsOper, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_MoleculePointerVector[] = {  {&_swigt__p_MoleculePointerVector, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_MoleculeVector[] = {  {&_swigt__p_MoleculeVector, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_std__allocatorT_MolpherMol_t[] = {  {&_swigt__p_std__allocatorT_MolpherMol_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_BoolVector,
  _swigc__p_ExplorationParameters,
  _swigc__p_ExplorationTree,
  _swigc__p_ExplorationTreeSnapshot,
  _swigc__p_ExtendTreeOper,
  _swigc__p_FilterMoprhsOper,
  _swigc__p_FindLeavesOper,
  _swigc__p_GenerateMoprhsOper,
  _swigc__p_MoleculePointerVector,
  _swigc__p_MoleculeVector,
  ...
  _swigc__p_reference,
  _swigc__p_size_type,
  _swigc__p_std__allocatorT_MolpherMol_t,
