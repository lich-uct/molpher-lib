...
_core.OP_ADD_ATOM_swigconstant(_core)
OP_ADD_ATOM = _core.OP_ADD_ATOM

_core.OP_REMOVE_ATOM_swigconstant(_core)
OP_REMOVE_ATOM = _core.OP_REMOVE_ATOM

_core.OP_ADD_BOND_swigconstant(_core)
OP_ADD_BOND = _core.OP_ADD_BOND

_core.OP_REMOVE_BOND_swigconstant(_core)
OP_REMOVE_BOND = _core.OP_REMOVE_BOND

_core.OP_MUTATE_ATOM_swigconstant(_core)
OP_MUTATE_ATOM = _core.OP_MUTATE_ATOM

_core.OP_INTERLAY_ATOM_swigconstant(_core)
OP_INTERLAY_ATOM = _core.OP_INTERLAY_ATOM

_core.OP_BOND_REROUTE_swigconstant(_core)
OP_BOND_REROUTE = _core.OP_BOND_REROUTE

_core.OP_BOND_CONTRACTION_swigconstant(_core)
...
_core.FP_ATOM_PAIRS_swigconstant(_core)
FP_ATOM_PAIRS = _core.FP_ATOM_PAIRS

_core.FP_MORGAN_swigconstant(_core)
FP_MORGAN = _core.FP_MORGAN

_core.FP_TOPOLOGICAL_swigconstant(_core)
FP_TOPOLOGICAL = _core.FP_TOPOLOGICAL

_core.FP_TOPOLOGICAL_LAYERED_1_swigconstant(_core)
FP_TOPOLOGICAL_LAYERED_1 = _core.FP_TOPOLOGICAL_LAYERED_1

_core.FP_TOPOLOGICAL_LAYERED_2_swigconstant(_core)
FP_TOPOLOGICAL_LAYERED_2 = _core.FP_TOPOLOGICAL_LAYERED_2

_core.FP_VECTORFP_swigconstant(_core)
FP_VECTORFP = _core.FP_VECTORFP

_core.FP_TOPOLOGICAL_TORSION_swigconstant(_core)
FP_TOPOLOGICAL_TORSION = _core.FP_TOPOLOGICAL_TORSION

_core.FP_EXT_ATOM_PAIRS_swigconstant(_core)
FP_EXT_ATOM_PAIRS = _core.FP_EXT_ATOM_PAIRS

_core.FP_EXT_MORGAN_swigconstant(_core)
FP_EXT_MORGAN = _core.FP_EXT_MORGAN

_core.FP_EXT_TOPOLOGICAL_swigconstant(_core)
FP_EXT_TOPOLOGICAL = _core.FP_EXT_TOPOLOGICAL

_core.FP_EXT_TOPOLOGICAL_LAYERED_1_swigconstant(_core)
FP_EXT_TOPOLOGICAL_LAYERED_1 = _core.FP_EXT_TOPOLOGICAL_LAYERED_1

_core.FP_EXT_TOPOLOGICAL_LAYERED_2_swigconstant(_core)
FP_EXT_TOPOLOGICAL_LAYERED_2 = _core.FP_EXT_TOPOLOGICAL_LAYERED_2

_core.FP_EXT_TOPOLOGICAL_TORSION_swigconstant(_core)
...
_core.SC_ALL_BIT_swigconstant(_core)
SC_ALL_BIT = _core.SC_ALL_BIT

_core.SC_ASYMMETRIC_swigconstant(_core)
SC_ASYMMETRIC = _core.SC_ASYMMETRIC

_core.SC_BRAUN_BLANQUET_swigconstant(_core)
SC_BRAUN_BLANQUET = _core.SC_BRAUN_BLANQUET

_core.SC_COSINE_swigconstant(_core)
SC_COSINE = _core.SC_COSINE

_core.SC_DICE_swigconstant(_core)
SC_DICE = _core.SC_DICE

_core.SC_KULCZYNSKI_swigconstant(_core)
SC_KULCZYNSKI = _core.SC_KULCZYNSKI

_core.SC_MC_CONNAUGHEY_swigconstant(_core)
SC_MC_CONNAUGHEY = _core.SC_MC_CONNAUGHEY

_core.SC_ON_BIT_swigconstant(_core)
SC_ON_BIT = _core.SC_ON_BIT

_core.SC_RUSSEL_swigconstant(_core)
SC_RUSSEL = _core.SC_RUSSEL

_core.SC_SOKAL_swigconstant(_core)
SC_SOKAL = _core.SC_SOKAL

_core.SC_TANIMOTO_swigconstant(_core)
SC_TANIMOTO = _core.SC_TANIMOTO

_core.SC_TVERSKY_SUBSTRUCTURE_swigconstant(_core)
SC_TVERSKY_SUBSTRUCTURE = _core.SC_TVERSKY_SUBSTRUCTURE

_core.SC_TVERSKY_SUPERSTRUCTURE_swigconstant(_core)
